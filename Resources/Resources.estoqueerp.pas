...
uses
  ...
  Controller.estoqueerp;

type

  [Resource('estoqueerp')]
  [Table('"Estoque".estoqueerp')]
  [AutoInc('estoqueerp_idestoqueerp_seq')]
  [Controllers(TControllerestoqueerp)]
  Testoqueerp = class(TResourceBaseClass)
  protected
  public
    [DBField('IDESTOQUEERP', True, True, False, PrimaryKey)]
    idestoqueerp: Integer;
